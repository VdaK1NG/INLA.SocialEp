...
vignette: >
  %\VignetteIndexEntry{Simulation Study - Data Creation}
...
```{r echo=FALSE}
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE, fig.align = "center", fig.width = 12)
...
```{r echo=FALSE}
ind.ef <- sim_sp_ef
ind.ef.g1 <- sim_sp_ef[2, ]
ind.ef.g2 <- sim_sp_ef[1, ]
ind.ef.g3 <- sim_sp_ef[3, ]
ind.ef.g4 <- sim_sp_ef[4, ]
```
